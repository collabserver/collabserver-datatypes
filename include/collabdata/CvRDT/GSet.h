...
class GSet {
   ...
   public:
     ...
     */
    bool empty() const { return _add.empty(); }
     ...
     */
    size_type size() const { return _add.size(); }
   ...
   public:
     ...
     */
    void insert(const T& value) { _add.insert(value); }
   ...
   public:
     ...
     */
    size_type count(const T& key) const { return _add.count(key); }
     ...
     */
    const_iterator find(const T& key) const { return _add.find(key); }
   ...
   public:
     ...
     */
    const_iterator cbegin() const { return _add.cbegin(); }
     ...
     */
    const_iterator cend() const { return _add.cend(); }
   ...
   public:
     ...
     */
    bool operator==(const GSet& lhs) const { return this->_add == lhs._add; }
     ...
     */
    bool operator!=(const GSet& lhs) const { return !(*this == lhs); }
