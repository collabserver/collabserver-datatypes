...
class GCounter {
   ...
   public:
     ...
     */
    void increment() { _map[_currentID] += 1; }
   ...
   public:
     ...
     */
    friend bool operator==(const GCounter& lhs, const GCounter& rhs) { return lhs.query() == rhs.query(); }
     ...
     */
    friend bool operator!=(const GCounter& lhs, const GCounter& rhs) { return !(lhs == rhs); }
