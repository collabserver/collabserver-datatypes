...
class GMap {
   ...
   public:
     ...
     */
    void insert(const value_type& value) { _map.insert(value); }
   ...
   public:
     ...
     */
    size_type count(const Key& key) const { return _map.count(key); }
     ...
     */
    const_iterator find(const Key& key) const { return _map.find(key); }
   ...
   public:
     ...
     */
    friend bool operator==(const GMap& lhs, const GMap& rhs) { return lhs._map == rhs._map; }
